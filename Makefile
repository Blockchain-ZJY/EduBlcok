...
anvil :; anvil -m 'test test test test test test test test test test test junk' --steps-tracing --block-time 1 --code-size-limit 65000
...
depoly-sepolia:
	...
	--private-key $(DEFAULT_SEPOLIA_PRIVITE_KEY)  --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
